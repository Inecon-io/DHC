...
class HoursHeadacheTable extends StatefulWidget {
  @override
  _HoursHeadacheTable createState() => _HoursHeadacheTable();
}

class _HoursHeadacheTable extends State<HoursHeadacheTable> {
  @override
