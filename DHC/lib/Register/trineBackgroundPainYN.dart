...
class BackGroundPainYN extends StatefulWidget {
  @override
  _BackGroundPainYN createState() => _BackGroundPainYN();
}

class _BackGroundPainYN extends State<BackGroundPainYN> {
